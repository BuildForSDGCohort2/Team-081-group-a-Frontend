...
function LandingPage() {
  ...
  return (
      <div className="landing-page">
        ...
        <div className="row">
          <div className="col-lg-12"><h1 className="welcomePageHeader" >Connecting students with great tutors</h1></div>
        </div>
